...
if not os.path.exists("noc_heter_high_throughput"):
    os.makedirs("noc_heter_high_throughput")
for root, dirs, files in os.walk("./template"):
    for file in files:
        if file.endswith(".txt"):
            text_file = os.path.join(root, file)
            text_dir=os.path.dirname(text_file)
            dest_folder="noc_heter_high_throughput/"+os.path.basename(text_dir)
...
#########################################################################################
os.rename("noc_heter_high_throughput.vhd", "noc_heter_high_throughput/noc_heter_high_throughput.vhd")
